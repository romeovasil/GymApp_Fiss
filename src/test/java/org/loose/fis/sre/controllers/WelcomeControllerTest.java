...
public class WelcomeControllerTest {
    ...
    @Test
    void testBookClass(FxRobot robot) throws NoReqSelected{



        robot.clickOn("#but");
        robot.clickOn("#but");
        assertThat(robot.lookup("#reqMessage").queryText()).hasText("No req selected");
    ...
    @Test
    void testReqStatus(FxRobot robot) throws Exception {
    ...
    @Test
    void testMembership(FxRobot robot) throws Exception {
